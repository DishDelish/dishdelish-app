...
public class ExampleRecipes {
    ...
    public static List<Recipe> recipes = Arrays.asList(
            new Recipe(R.drawable.omelette_pic, "Omelette", "John Johnathan",
                    ...
                    Arrays.asList(new Pair<>(new Unit(5, "pieces"), EGGS), new Pair<>(new Unit(5, "g"), OIL), new Pair<>(new Unit(5, "g"), BUTTER)),
            ...
            new Recipe(R.drawable.lemon_pudding, "Lemon Pudding", "Smaug the Golden",
                    ...
                    Arrays.asList(new Pair<>(new Unit(1, "piece"), LEMON), new Pair<>(new Unit(100, "g"), SUGAR), new Pair<>(new Unit(100, "g"), BUTTER), new Pair<>(new Unit(100, "g"), FLOUR), new Pair<>(new Unit(5, "pieces"), EGGS)),
                    Arrays.asList("STEP 1\n" +
